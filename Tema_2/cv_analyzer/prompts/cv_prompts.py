# -----/---------/ --plantillas de prompts para envial al lm -----/---------/ --
...
# funció0n auxiliar que lanza el prompt, se pueden crear mas funciones y asignar variuables globales de prompts para lanzarlos personalizados
