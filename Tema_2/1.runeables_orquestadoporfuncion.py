...
# =**====***====***======***=======***=========***==========***=======
# PROCESAMIENTO PRINCIPALOR DE FLUJO - CONTROLA EL ORDEN DE LAS TAREAS 
# =**====***====***======***=======***=========***==========***=======
# Esta función coordina todo el flujo.
# Ejecuta resumen, sentimiento y unión de resultados.
def process_one(text):
    ...
    sentimiento_data = analyze_sentiment(text)
...
# Convertimos la función en Runnable para usarla en LCEL.
process = RunnableLambda(process_one)

# =====================================================
# CONSTRUCCIÓN DE LA CADENA
# =====================================================
# El operador | conecta la salida del primer Runnable
# con la entrada del segundo Runnable.
#
# texto
#   ↓
# preprocessor
...
# EJECUCIÓN
# =====================================================
# invoke() es el método estándar para ejecutar un Runnable.
